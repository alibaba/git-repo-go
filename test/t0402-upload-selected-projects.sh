...
test_expect_success "upload with args: main, projects/app1" '
	(
		...
		NOTE: will execute command: git push --receive-pack=agit-receive-pack ssh://committer@ssh.example.com:22/project1.git refs/heads/my/topic1:refs/for/maint/my/topic1
